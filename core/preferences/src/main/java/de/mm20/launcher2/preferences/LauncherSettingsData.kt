...
data class LauncherSettingsData internal constructor(
    ...
    val focusQuietHoursStartMinutes: Int = 20 * 60,
    val focusQuietHoursEndMinutes: Int = 8 * 60,
    val focusDesaturateDistractingApps: Boolean = true,
    val focusSessionEndsAt: Long = 0L,
    val focusMinimalHome: Boolean = true,
    val focusNoIconsMode: Boolean = false,
    val focusEnableDnd: Boolean = false,
    ...
    val focusProductivityWindow2EndMinutes: Int = 7 * 60,
    val focusApplyToPersonalProfile: Boolean = true,
    val focusApplyToWorkProfile: Boolean = true,
    val focusApplyToPrivateProfile: Boolean = true,
    ...
    val gridListIcons: Boolean = false,
    ...
    val gesturesDoubleTap: GestureAction = GestureAction.NoAction,
